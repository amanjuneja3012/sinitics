<template>
  <div>
    <div 
      id="pricingDesktop" 
      class="is-hidden-touch pricing-desktop">
      <div class="pricing-container">
        <p class="page-title top-title">{{ $t('pricing.title') }}</p>
        <div class="toggle">
          <p 
            :class="{ 'active-type' : selectedMonthly }" 
            class="monthly" >{{ $t('pricing.checkBoxDetails.leftStr') }}</p>
          <label class="switch" >
            <input 
              type="checkbox" 
              checked 
              @click="changeSelctedType" >
            <span class="slider round"/>
          </label>
          <p 
            :class="{ 'active-type' : selectedYearly }" 
            class="yearly" >{{ $t('pricing.checkBoxDetails.rightStr') }}</p>
          <p 
            v-if="$device.isDesktop" 
            class="tagss" >{{ $t('pricing.checkBoxDetails.tag') }}</p>
        </div>
        <div class="currencyChange">
          <div 
            v-for="currency in currenciesArr" 
            :class="(selectedCurrency['key']==currency['key'])?'selected':''" 
            class="icon" 
        ...
        <div 
          ...
          <div class="tabs">
            <div 
              ...
              class="tab" 
              @click="ActivateFirst">{{ $t('pricing.tableData.sectorsWidget.tabs[0]') }}</div>
            <div 
              :class="{ active: isActiveSecond }" 
              class="tab" 
              @click="ActivateSecond">{{ $t('pricing.tableData.sectorsWidget.tabs[1]') }}</div>
          </div>
          <div 
            :class="{ active: isActiveFirst }" 
            class="sector-cards">
            <div 
              v-for="(obj,index) in $t('pricing.tableData.sectorsWidget.Basic')" 
              class="inline inlineFlex inline-flex">
              <CardWithIcon
                :title="obj.title"
                :subtitle="obj.subtitle"
                :detail="obj.detail"
                :icon-url="obj.iconUrl"
                :hover-image="obj.imageUrl"
                width="270px"
              />
            </div>
          </div>
    ...
    <div 
      id="pricingMobile" 
      class="is-hidden-desktop pricing-mobile">
      <div class="pricing-container">
        <p class="page-title top-title">{{ $t('pricing.title') }}</p>
        <div class="toggle">
          <p 
...
.pricing-mobile .monthly,
.pricing-mobile .yearly {
  font-size: 18px;
}
