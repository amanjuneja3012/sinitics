<template>
    <div>
        ...
        <div class="card-container carousel-card-container is-hidden-desktop mobileContentCard">
            <no-ssr placeholder="Loading...">
                <carousel paginationActiveColor="#42b983" paginationColor="#b2ebd1" :paginationSize=5 easing="linear" :speed=300 :perPage=1 >
                    <slide v-for="(slideObj, index) in slides" :key="index">
                        <ActionContent
...
<style scoped>
    .card-container.mobileContentCard{
        display: flex;
        width: 100%;
    ...
    .carousel-card-container.mobileContentCard{
        .VueCarousel{
